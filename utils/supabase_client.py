...
SUBSYSTEM_CONFIG = {
    'hr1': {'department': 'HR', 'name': 'Personnel Management'},
    'hr2': {'department': 'HR', 'name': 'HR Subsystem 2'},
    'hr3': {'department': 'HR', 'name': 'HR Subsystem 3'},
    'hr4': {'department': 'HR', 'name': 'HR Subsystem 4'},
    'ct1': {'department': 'CORE_TRANSACTION', 'name': 'Core Transaction 1'},
    'ct2': {'department': 'CORE_TRANSACTION', 'name': 'Core Transaction 2'},
    'ct3': {'department': 'CORE_TRANSACTION', 'name': 'Core Transaction 3'},
    'log1': {'department': 'LOGISTICS', 'name': 'Logistics 1'},
    'log2': {'department': 'LOGISTICS', 'name': 'Logistics 2'},
    'fin1': {'department': 'FINANCIALS', 'name': 'Financials 1'},
    'fin2': {'department': 'FINANCIALS', 'name': 'Financials 2'},
    'fin3': {'department': 'FINANCIALS', 'name': 'Financials 3'},
    'fin4': {'department': 'FINANCIALS', 'name': 'Financials 4'},
    'fin5': {'department': 'FINANCIALS', 'name': 'Financials 5'},
}
